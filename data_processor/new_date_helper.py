...
class Data_Process(object):
    ...
    def _yoochoose_item_attr(self,data_home='./yoochoose',saved_path='./dataset'):
        category_dict={}
    ...
    def _yoochoose_(self,frac = 4,data_home='./yoochoose',saved_path='./dataset'):
        """
        ...
        os.makedirs(f'{saved_path}/{out_path}')
    ...
    """
        def _read_diginetica(self,data_home='./yoochoose',saved_path='./dataset'):
            diginetica raw_data:
            保留具有userid的数据
    ...
    def _read_raw_data(self,dataset_name):
        ...
        """
        cold_session=self.conf.cold_session
        cold_item=self.conf.cold_item
    ...
    def _get_sample_adj(self,G):
        ...
        adj_size = self.conf.graph_adj_size
        N = self.conf.n_items
...
class LastFM_Process(Data_Process):
    ...
    def _read_raw_data(self,topK=40000):
        ...
        if not os.path.exists(f'{saved_path}/lastfm'):
            os.makedirs(f'{saved_path}/lastfm')
