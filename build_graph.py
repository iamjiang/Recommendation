...
def userTopItems(dataset,K=10):
    data_path=os.path.join(os.getcwd(),"data_processor","dataset",dataset)
    ...
    with open(os.path.join(data_path,'userTopItems.pkl'),'wb') as f:
...
def itemTopUsers(dataset,K=10):
    ...
    with open(os.path.join(data_path,'itemTopUtems.pkl'),'wb') as f:
...
def userCF(dataset):
    ...
    with open(os.path.join(data_path,'u2u_sim.pkl'), 'wb') as f:
        pickle.dump(user_topK, f)
...
def itemCF(dataset):
    ...
    with open(os.path.join(data_path,'i2i_sim.pkl'), 'wb') as f:
        pickle.dump(item_topK, f)
...
def uui_graph(dataset_name, sample_size, topK, add_u = True, add_v = True):
    ...
    src_v = []
    dst_u = []
    data_path=os.path.join(os.getcwd(),"data_processor","dataset",dataset_name)
    with open(os.path.join(data_path,'train.pkl'),'rb') as f:
        graph = pickle.load(f)

    with open(os.path.join(data_path,f'adj_{sample_size}.pkl'), 'rb') as f:
        adj = pickle.load(f)
    adj_in = adj[0]
    adj_out = adj[1]
    ...
    with open(os.path.join(data_path,'u2u_sim.pkl'), 'rb') as f:
        u2u_sim = pickle.load(f)

    with open(os.path.join(data_path,'i2i_sim.pkl'),'rb') as f:
...
def sample_relations(dataset_name, num, sample_size=20):
    ...
    with open(os.path.join(data_path,f'adj_{sample_size}.pkl'), 'wb') as f:
